...
| v0.37.13 | Implemented | Surface and composition completion: CLI/TUI ownership, startup and dispatch wiring, uninstall orchestration, application adapters under `app`, thin `main`/private `lib` entry facade, zero root compatibility facades, and complete migration ledger; release pending |
