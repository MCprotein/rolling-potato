...
| v0.40.0 | In progress | Package-manager distribution: `Generated` Homebrew/Scoop/winget manifests from exact GitHub Release checksums with static contracts passing; six-lane native `Validated` status is pending and all external channels are `Unpublished` |
