...
| v0.31.0 | Released | Backend streaming and cancellation: managed-sidecar SSE responses, explicit generation cancellation, bounded timeout cleanup, and lifecycle/resource/model-run evidence without weakening policy gates |
