...
| v0.30.0 | In Progress | Verified model adoption: Qwen/Gemma pinned-artifact local evaluation completed; canonical chat/benchmark/RAM/mmproj provenance gate, managed registry install, fail-closed persistent default selection, and derived project-ledger recovery implemented without bundling weights; release gates remain |
