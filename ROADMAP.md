...
| v0.40.0 | Released | Package-manager distribution: exact-checksum Homebrew/Scoop/winget manifests, strict format contracts, and clean-install/upgrade/uninstall lifecycles validated across six native lanes; external channel publication remains separately evidenced |
