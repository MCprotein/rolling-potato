...
| v0.29.0 | In Progress | Durable single-agent patch loop implementation: `run` persists canonical workflow/action state, rereads source for a proposal, and resumes through bound approval, guarded apply, verification evidence, stop gate, and deterministic Korean reporting |
