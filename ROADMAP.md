...
| v0.29.0 | In Progress | Durable single-agent runtime correction: preserve the restart-safe patch loop while restoring generic workflow/action boundaries, non-patch `run`, ontology-backed context, separate apply/verification approvals, canonical ledger authority, and deterministic Korean reporting |
