...
7. Extend `rpotato patch` from diff display and dry-run approval gate to approved patch apply, rollback/failure handling, verification command flow, and stop gate.
