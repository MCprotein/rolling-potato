...
Backend CPU/RSS/disk resource sampling은 `backend start`, `backend status`, `backend chat`, `monitor status`에서 사용할 수 있습니다. TUI resource-pressure 표시는 v0.10.0, runtime resource governor 동작은 v0.11.0+에 배치합니다.
