...
pub(crate) use crate::surfaces::tui::runtime_bridge::{
    ...
    TuiReadBudget, TuiReadContinuation, TuiReadPage, TuiReadRequest,
};
use crate::{
...
fn tui_read_freshness(
    ...
    let projection_status = match crate::transition::projection_lag_status_read_only(project_id) {
        ...
        crate::transition::ProjectionLagReadStatus::Unavailable => ProjectionStatus::Unavailable,
    };
