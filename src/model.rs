...
use crate::runtime_core::inference::model::manifest::{
    BackendSmokeEvidence, CandidateStatus, DefaultSelection, InstallValidation, LocalArtifactState,
    ModelArtifactDescriptor, ModelArtifactFetchStatus, ModelManifestEntry, PromotionEvidence,
    PromotionReadiness, RegistryEntry, CANDIDATES, STATUS_SCHEMA,
};
