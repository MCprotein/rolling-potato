...
use crate::runtime_core::workflow::application::transaction_coordinator::{
    PlannedEvent, TransactionCoordinator,
};
use crate::runtime_core::workflow::storage_compat::ledger::{
    planned_event_hash, LedgerBinding, LedgerEvent, ParsedLedgerEvent,
};

use super::super::transition;
use super::derived::{converge_derived_outputs_unlocked, validate_derived_outputs_unlocked};
use super::storage::{append_chained_event, read_runtime_events_unlocked};
...
impl LedgerWriterGuard {
    ...
    #[cfg(test)]
    pub(super) fn acquire_after_first_block(
