//! Team manifest/state DTOs and stage transition policy.
...
pub use manifest_codec::parse_manifest;
pub(crate) use state_codec::{
    immutable_binding_changed, parse_state, render_payload, render_state, validate_state,
};
pub(crate) use validation::{is_sha256, validate_id};
