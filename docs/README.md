...
English documentation is the default surface for `rolling-potato`.

Korean translations and Korean originals are kept under [docs/ko/](ko/). The root-level Korean README is [README.ko.md](../README.ko.md).
