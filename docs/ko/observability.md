...
| v0.12.0+ | subagent/team admission | 관측한 pressure로 subagent/team concurrency 제한, sequential fallback 선호, model downgrade/escalation hint 표시 |
...
- resource pressure 기반 subagent/team admission control
