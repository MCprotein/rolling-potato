...
| v0.11.0+ | resource governor | 관측한 pressure로 context/max token clamp, subagent/team concurrency 제한, sequential fallback 선호, model downgrade/escalation hint 표시 |
...
- managed backend sidecar의 지속 CPU/memory/disk resource sampling
- resource pressure classification과 governor behavior
