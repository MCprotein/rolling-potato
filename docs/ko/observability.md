...
| v0.16.0+ | 남은 dispatcher governor policy | approval queue integration, context/model clamp, dispatch-time ownership enforcement, model downgrade/escalation hint 추가 |
...
- approval queue integration, dispatch-time ownership enforcement, context/model admission check
