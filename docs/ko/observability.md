...
| v0.17.0+ | 남은 dispatcher governor policy | context/model clamp, dispatch-time ownership enforcement, model downgrade/escalation hint 추가 |
...
- dispatch-time ownership enforcement, context/model admission check
