...
| v0.14.0+ | 남은 dispatcher governor policy | file ownership, tool risk, approval queue, context/model clamp, model downgrade/escalation hint 추가 |
...
- file ownership, tool risk, approval queue, context/model admission check
