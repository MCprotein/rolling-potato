...
| v0.29.0 | Planned | 지속 가능한 end-to-end single-agent patch loop: `run` model action을 영속화된 workflow/action/approval/evidence state, patch proposal, 명시적 승인, guarded apply, verification 결과 해석, stop-gate evidence, 한국어 최종 보고까지 연결 |
