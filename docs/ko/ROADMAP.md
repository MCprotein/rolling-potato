...
| v0.31.0 | Released | Backend streaming과 cancellation: managed sidecar SSE 응답, 명시적 generation 취소, bounded timeout cleanup, policy gate를 약화하지 않는 lifecycle/resource/model-run evidence 기록 |
