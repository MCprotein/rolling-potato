...
| v0.35.0 | Released | Bounded subagent 실행: scoped context, 선언된 tool, write ownership, resource limit, strict structured result, terminal failure handling, restart-safe parent evidence merge, secret-safe output persistence |
