...
| v0.40.0 | Released | Package manager 배포: exact checksum 기반 Homebrew/Scoop/winget manifest, strict format contract, clean-install/upgrade/uninstall lifecycle을 native 6개 lane에서 검증했으며 외부 channel 게시는 별도 evidence로 추적 |
