...
| v0.23.0 | Planned | 공식 binary download foundation: release build pipeline, GitHub Release asset, macOS Apple Silicon `rpotato` artifact, binary checksum, `rpotato doctor` release smoke |
