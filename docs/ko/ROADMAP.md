...
### 대화 interface 개선과 신뢰성 복구 (`v0.46.0`-`v0.46.1`)
...
| v0.46.1 | Released | 오래 남은 실패 workflow 복구, 소형 모델 non-thinking chat request, 명시적 작업 routing, Enter 전 live slash-command palette로 실제 기본 대화를 복구 |
