...
| Version | 상태 | 범위 |
| --- | --- | --- |
| v0.42.0 | In development | GitHub Release archive self-install과 전체 관리형 uninstall: 사용자 전용 binary 배치·삭제, 멱등 zsh/bash/fish 또는 Windows 사용자 PATH 등록·해제, `init` 환경 보정, dry-run·명시적 확인·active runtime 삭제 차단 |
