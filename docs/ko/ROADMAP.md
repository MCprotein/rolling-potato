...
| v0.29.0 | Released | 지속 가능한 single-agent runtime 보정: restart-safe patch loop를 보존하면서 범용 workflow/action 경계, 비패치 `run`, ontology-backed context, 분리된 patch/verification 승인, canonical ledger 권위, deterministic 한국어 보고를 복구 |
