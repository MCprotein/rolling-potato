...
### 제한된 웹 연구와 browser interaction (`v0.48.0`)

| Version | 상태 | 범위 |
| --- | --- | --- |
| v0.48.0 | In development | [제한된 웹 연구와 Chromium browser 계획](v0.48-web-research-browser-plan.md): API key·MCP·Node.js 없이 Search→Open→Find 근거 loop, 검증된 source 연결, multi-page TUI와 격리된 installed-browser action |
