...
| Version | 상태 | 범위 |
| --- | --- | --- |
| v0.44.0 | In development | 새 stable release를 알리는 non-blocking cached startup check와 관리형 사용자 설치본을 platform-exact archive 및 SHA-256 검증으로 교체하는 one-command self-update |
