...
require_marker README.md 'Current release | `v0.49.4`'
require_marker README.ko.md '현재 릴리즈 | `v0.49.4`'
...
require_marker docs/tui.md '### Restricted Browser Search Form (v0.50 Source Candidate)'
require_marker docs/ko/tui.md '### 제한된 브라우저 Search Form (v0.50 Source Candidate)'
require_marker docs/current-capabilities.md 'v0.50 source candidate'
require_marker docs/ko/current-capabilities.md 'v0.50 source candidate'
