...
scripts/ci/verify-local-tool-schema-contract.sh
cargo fmt --all -- --check
...
printf 'PR candidate preflight ok: tool-pins web-browser-docs local-tool-schema format model-upgrade subagent-lifecycle native-terminal architecture clippy workflow-contract\n'
